...
var metrics = struct {
	...
	JvmInfo:              metric("container_jvm_info", "Meta information about the JVM", "jvm", "java_version", "max_heap_size", "initial_heap_size", "max_ram_percentage", "initial_ram_percentage", "min_ram_percentage", "gc_type"),
