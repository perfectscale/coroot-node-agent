...
var metrics = struct {
	...
	JvmInfo:              metric("container_jvm_info", "Meta information about the JVM", "jvm", "java_version", "max_heap_size", "initial_heap_size", "max_heap_percentage", "initial_heap_percentage", "xx_options"),
