...
var metrics = struct {
	...
	OOMKillsInfo: metric("container_oom_kills_info", "OOM kills with context information", "process_name", "memory_pressure", "node_memory_usage", "container_memory_usage"),
	...
	JvmInfo:              metric("container_jvm_info", "Meta information about the JVM", "jvm", "java_version", "max_heap_size", "initial_heap_size", "max_heap_percentage", "initial_heap_percentage", "min_ram_percentage", "gc_type"),
